    ...
    <div @class([
        ...
        <main @class([
            ...
            <div @class([
                ...
                <p @class(['mb-2', 'text-[#706f6c]', 'dark:text-[#A1A09A]'])>Laravel has an incredibly rich ecosystem. <br>We suggest starting with
                    the following.</p>
                <ul @class(['flex', 'flex-col', 'mb-4', 'lg:mb-6'])>
                    <li @class([
                        ...
                        <span>
                            Read the
                            <a href="https://laravel.com/docs" target="_blank" @class([
                                'inline-flex',
                                'items-center',
                                'space-x-1',
                                'font-medium',
                    ...
                    <li @class([
                        ...
                        <span>
                            ...
                            <a href="https://laracasts.com" target="_blank" @class([
                                'inline-flex',
                                'items-center',
                                'space-x-1',
                                'font-medium',
                ...
                <ul @class(['flex', 'gap-3', 'text-sm', 'leading-normal'])>
                    <li>
                        <a href="https://cloud.laravel.com" target="_blank" @class([
                            'inline-block',
                            'dark:bg-[#eeeeec]',
                            'dark:border-[#eeeeec]',
                            'dark:text-[#1C1C1A]',
            ...
            <div @class([
                ...
                <svg @class([
                    ...
                    <g style="mix-blend-mode: hard-light" @class([
                        'transition-all',
                        'delay-300',
                        'translate-y-0',
                        'opacity-100',
                    ...
                    <g style="mix-blend-mode: plus-darker" @class([
                        'transition-all',
                        'delay-300',
                        'translate-y-0',
                        'opacity-100',
