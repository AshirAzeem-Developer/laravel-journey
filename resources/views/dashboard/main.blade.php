        ...
        <div class="dashboard-container flex">
            <main class="flex-1  ">
                <div class="max-w-7xl mx-auto">
                    ...
                    <x-slot name="desc">
                        {{ __('   A quick summary of system-wide performance and activity.') }}
                    </x-slot>

                    @if (isset($viewPartial))
                        {{-- Dynamically include the content partial with animation --}}
                        <div class="content-wrapper animate-fadeIn">
                            @include('dashboard.partials.' . $viewPartial, $summaryData ?? [])
                        </div>
                    @else
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            {{-- Total Users Card --}}
                            <div
                                class="stat-card bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Total Users
                                        </p>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Open
                                            Tickets</p>
                                        <h3 class="text-4xl font-bold text-gray-900 dark:text-white">
                                            {{ $tickets->count() }}</h3>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <a href="{{ route('dashboard.section', 'users') }}"
                                    class="quick-action-btn flex flex-col items-center p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all duration-200">
                                    <svg class="w-8 h-8 text-indigo-600 dark:text-indigo-400 mb-2" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                                    </svg>
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Manage
                                        Users</span>
                                </a>
                                ...
                                <a href="{{ route('dashboard.section', 'sessions') }}"
                                    ...
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">View
                                        Sessions</span>
                                </a>
                                ...
                                <a href="{{ route('dashboard.section', 'jobs') }}"
                                    ...
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Check
                                        Jobs</span>
                                </a>
