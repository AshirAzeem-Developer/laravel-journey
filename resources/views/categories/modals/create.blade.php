        ...
        <form action="{{ route('admin.storeCategory') }}" method="POST" class="relative z-10">
            ...
            <div class="space-y-5">
                ...
                <div class="group">
                    ...
                    <input type="text" id="addCategoryName" name="category_name"
                        class="w-full px-4 py-3 bg-[#0f1621]/80 backdrop-blur-sm border border-[#2d3b4e] rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-[#3d4b5e]"
                        placeholder="Enter category name" required>
                    <x-input-error :messages="$errors->get('category_name')" class="mt-2 text-sm text-red-400" />
                </div>
                ...
                <div class="group">
                    ...
                    <textarea id="addCategoryDescription" name="description" rows="4"
                        class="w-full px-4 py-3 bg-[#0f1621]/80 backdrop-blur-sm border border-[#2d3b4e] rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-[#3d4b5e] resize-none"
