<x-guest-layout>
    ...
    <main class="relative mt-0">
        <div
            class="flex items-start min-h-screen bg-cover bg-center"
            style="
            ...
            <div class="container mx-auto my-auto px-4 py-12">
                <div class="flex justify-center">
                    <div class="w-full lg:w-4/12 md:w-8/12 px-4">
                        <div class="relative flex flex-col min-w-0 break-words bg-white rounded-3xl shadow-xl animate-fade-in-down">
